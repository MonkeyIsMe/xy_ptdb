...
<div class="container" style="width: 100%">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div>
                <table id="diagtype" class="table table-bordered table-hover table-striped" data-toggle="table">
                </table>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $('#diagtype').bootstrapTable({
    	url : 'queryDiagType.action', // 请求后台的URL（*）
 		method : "post",
 		//toolbar : "#toolbar",
 		pagination : "true",
 		search : "true",
